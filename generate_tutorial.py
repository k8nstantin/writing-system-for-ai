...
<div class="tutorial-panel">
  ...
  <div class="lesson-tabs">
    <button class="tab-btn active" id="tab0">Rung 1</button>
    <button class="tab-btn" id="tab1">Rung 2</button>
    <button class="tab-btn" id="tab2">Rung 3</button>
  </div>
...
<script>
  ...
  // Bind tab buttons to load lesson
  document.getElementById('tab0').addEventListener('click', () => loadLesson(0));
  document.getElementById('tab1').addEventListener('click', () => loadLesson(1));
  document.getElementById('tab2').addEventListener('click', () => loadLesson(2));
  ...
  function updateChecklist() {
    ...
    l.targetKeys.forEach((keyName, i) => {
      ...
      // Beautify key names for checklist
