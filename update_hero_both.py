...
start_marker = '<p class="sub">Here is a thought — not written in English'
end_marker = '<strong>One meaning, one form.</strong></p>'
...
if start_marker in content and end_marker in content:
    ...
    new_section = """<p class="sub">Here is a simple thought — not written in English, not in any tongue anyone speaks, but in the writing system this page is about:</p>
    ...
    <p class="sub" style="margin-bottom: 40px;">It says: <em>"I want you to know this."</em> And it is the only way to write that thought — two people would type it identically, and so would two machines.</p>

    <p class="sub" style="margin-top: 40px;">Now, here is a more complex thought — the opening line of Alan Turing's 1950 paper on AI:</p>
    <div class="glyphline-visual" style="display: flex; flex-direction: column; gap: 10px; font-size: 18px; font-family: var(--mono); padding: 14px 0px;">
      <div style="display: flex; align-items: flex-start; gap: 12px;">
        <!-- sai prime -->
