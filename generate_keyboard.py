...
<div class="split-keyboard">
  ...
  <div class="half right">
    ...
    <div class="row" style="padding-right: 10px;">
      ...
      <div class="key desc" data-flip="Y"><svg viewBox="0 0 24 24" fill="none" stroke-width="2"><rect x="4" y="4" width="16" height="16" /><polygon points="8,16 16,16 18,7 6,7" fill="#e2e8f0" /></svg></div>
      <div class="key desc" data-flip="X"><svg viewBox="0 0 24 24" fill="none" stroke-width="2"><polyline points="15,5 9,12 15,19" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg></div>
