...
<div class="split-keyboard">
  ...
  <div class="half right">
    ...
    <div class="thumb-cluster right">
      ...
      <div class="key macro tall" style="border-top-color: #a388ed;"><svg viewBox="0 0 24 24" fill="none" stroke="#a388ed" stroke-width="2"><polygon points="12,2 21,7 21,17 12,22 3,17 3,7" /><circle cx="12" cy="7.5" r="2" fill="#a388ed" /><circle cx="8" cy="14.5" r="2" fill="#a388ed" /><circle cx="16" cy="14.5" r="2" fill="#a388ed" /></svg></div>
