...
<div class="split-keyboard">
  ...
  <div class="half right">
    ...
    <div class="thumb-cluster right">
      ...
      <div class="key macro tall" style="border-top-color: #ffd166;"><svg viewBox="0 0 24 24" fill="none" stroke="#ffd166" stroke-width="2"><polygon points="12,22 22,15 18,4 6,4 2,15" /><polyline points="6,18 12,6 18,18" /><circle cx="12" cy="10" r="2" fill="#ffd166" /><circle cx="12" cy="14" r="2" fill="#ffd166" /></svg></div>
