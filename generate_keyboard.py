...
<div class="split-keyboard">
  ...
  <div class="half right">
    ...
    <div class="thumb-cluster right">
      ...
      <div class="key macro tall" style="border-top-color: #ffd166;"><svg viewBox="0 0 24 24" fill="none" stroke="#ffd166" stroke-width="2"><polygon points="12,2 21,7 21,17 12,22 3,17 3,7" /><circle cx="12" cy="10" r="2" fill="#ffd166" /><circle cx="12" cy="14" r="2" fill="#ffd166" /></svg></div>
