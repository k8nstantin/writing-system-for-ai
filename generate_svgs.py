...
categories = [
    {
        ...
        "glyphs": [
            ...
            {"handle": "k8n", "desc": "reserved", "svg": '<g stroke="#ffd166"><polygon points="12,22 22,15 18,4 6,4 2,15" /><polyline points="6,18 12,6 18,18" /><circle cx="12" cy="10" r="2" fill="#ffd166" /><circle cx="12" cy="14" r="2" fill="#ffd166" /></g>'},
