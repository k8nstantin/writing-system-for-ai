...
categories = [
    ...
    },
    {
        ...
        "glyphs": [
            ...
            {"handle": "blw", "desc": "below (above with star below)", "svg": '<line x1="2" y1="18" x2="22" y2="18" /><polyline points="8,10 12,4 16,10" /><line x1="12" y1="4" x2="12" y2="14" /><polygon points="9,18.5 12,19.7 15,18.5 13.8,19.9 16,20.7 13.5,21.3 12,23.0 10.5,21.3 8,20.7 10.2,19.9" fill="currentColor" stroke="none" />'},
            ...
            {"handle": "lft", "desc": "left (right with left star)", "svg": '<line x1="12" y1="2" x2="12" y2="22" /><rect x="14" y="8" width="6" height="8" fill="#e2e8f0" /><polygon points="1,10 4,11.2 7,10 5.8,11.4 8,12.2 5.5,12.8 4,14.5 2.5,12.8 0,12.2 2.2,11.4" fill="currentColor" stroke="none" />'},
            {"handle": "rgt", "desc": "right", "svg": '<line x1="12" y1="2" x2="12" y2="22" /><rect x="14" y="8" width="6" height="8" fill="#e2e8f0" />'},
            {"handle": "in", "desc": "inside", "svg": '<rect x="4" y="6" width="16" height="16" /><rect x="9" y="11" width="6" height="6" fill="#e2e8f0" />'},
            {"handle": "out", "desc": "outside (in with top star)", "svg": '<rect x="4" y="6" width="16" height="16" /><rect x="9" y="11" width="6" height="6" fill="#e2e8f0" /><polygon points="9,1 12,2.2 15,1 13.8,2.4 16,3.2 13.5,3.8 12,5.5 10.5,3.8 8,3.2 10.2,2.4" fill="currentColor" stroke="none" />'},
            {"handle": "water", "desc": "water / ocean", "svg": '<path d="M 3,8 Q 7.5,5 12,8 T 21,8 M 3,14 Q 7.5,11 12,14 T 21,14 M 3,20 Q 7.5,17 12,20 T 21,20" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none" />'},
    ...
    },
    {
        ...
        "glyphs": [
            ...
            {"handle": "jesus", "desc": "reserved", "svg": '<g stroke="#a388ed"><polygon points="12,2 21,7 21,17 12,22 3,17 3,7" /><circle cx="12" cy="7.5" r="2" fill="#a388ed" /><circle cx="8" cy="14.5" r="2" fill="#a388ed" /><circle cx="16" cy="14.5" r="2" fill="#a388ed" /></g>'},
...
for cat in categories:
    ...
    for glyph in cat['glyphs']:
        if glyph['handle'] == 'jesus':
            stroke_color = "#a388ed"
        elif glyph['handle'] in ['alan', 'carl', 'reserved']:
            stroke_color = "#ffd166"
        else:
            stroke_color = "#e2e8f0"
