                    ...
                    <div class="arg-line">
                      ...
                      <div class="list-items" style="display:flex; align-items:center; gap:8px;">
                        ...
                        <div style="position:relative; width:28px; height:28px;" title="ANGEL">
                          ...
                          <svg viewBox="0 0 24 24" fill="none" stroke="#333" stroke-width="2" style="position:absolute; top:0; left:0; transform:scale(0.5); transform-origin: center;"><line x1="2" y1="18" x2="22" y2="18" /><polyline points="8,10 12,4 16,10" /><line x1="12" y1="4" x2="12" y2="14" /></svg>
                        </div>
                        <span style="font-size:12px;">∨</span>
                        <!-- DEMON: hex + blw -->
                        <div style="position:relative; width:28px; height:28px;" title="DEMON">
                          <svg viewBox="0 0 24 24" fill="none" stroke="#333" stroke-width="2"><polygon points="12,2 21,7 21,17 12,22 3,17 3,7" /></svg>
                          <svg viewBox="0 0 24 24" fill="none" stroke="#333" stroke-width="2" style="position:absolute; top:0; left:0; transform:scale(0.5); transform-origin: center;"><line x1="2" y1="6" x2="22" y2="6" /><polyline points="8,14 12,20 16,14" /><line x1="12" y1="20" x2="12" y2="10" /></svg>
                        </div>
                        <span style="font-size:12px;">∨</span>
                              ...
                              <div class="args-block">
                                <div class="arg-line">
                                  ...
                                  <div style="position:relative; width:32px; height:32px; margin-top:2px;" title="GOD">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="#333" stroke-width="2"><polygon points="12,2 21,7 21,17 12,22 3,17 3,7" /></svg>
                                    <svg viewBox="0 0 24 24" fill="none" stroke="#333" stroke-width="2" style="position:absolute; top:0; left:0; transform:scale(0.5); transform-origin: center;"><polygon points="12,2 22,12 12,22 2,12" fill="#333"/></svg>
                                  </div>
                                </div>
                                <div class="arg-line">
                                  <span class="role-label">pat</span>
